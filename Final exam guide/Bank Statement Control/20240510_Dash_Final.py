...
### Import Data ###
# Bank_Coding Sheet
sheet_url = 'https://docs.google.com/spreadsheets/d/1kd84jHBZFQg_gvjSOb3_7bLhohlhOVZvZioC83weq4Q/edit#gid=732370204'
csv_export_url = sheet_url.replace('/edit#gid=', '/export?format=csv&gid=')
df_coding = pd.read_csv(csv_export_url)

# GL Sheet
sheet_url = 'https://docs.google.com/spreadsheets/d/1kd84jHBZFQg_gvjSOb3_7bLhohlhOVZvZioC83weq4Q/edit#gid=0'
csv_export_url = sheet_url.replace('/edit#gid=', '/export?format=csv&gid=')
